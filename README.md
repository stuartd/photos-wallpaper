...
This functionality is no longer available in macOS 26 (Tahoe), so this application recreates it using agentic coding for features, tests and polish aiming for an indie release.
